...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "Por favor iinsira o mesmo valor novamente.",
		maxlength: $.validator.format( "Por favor não insira mais que {0} caracteres." ),
		minlength: $.validator.format( "Por favor não insira menos que {0} caracteres." ),
		rangelength: $.validator.format( "Por favor insira um valor entre {0} e {1} " ),
